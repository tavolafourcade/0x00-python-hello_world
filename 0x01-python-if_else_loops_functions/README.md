...
## Overview
This project introduced us to how to use various conditionals and loops in Python like `if`, `if...else`, `while`, `for`, `break`, `continue`, `pass`, `range`, and `return`. It also introduced us to variable scope and basic arithmetic operators using python.
